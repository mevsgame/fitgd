 ...
 *
 * Features:
 * - Displays crew momentum with GM controls (+/-)
 * - Shows crew progress/threat clocks with SVG previews
 * - Character cards with portraits, harm clocks, and Take Action buttons
 * - Double-click character to open sheet
 * - Session persistence (auto-restores on page load)
 *
...
export class CrewHUDPanel extends Application {
     ...
     * @param type - 'harm' | 'progress' | 'threat'
     */
